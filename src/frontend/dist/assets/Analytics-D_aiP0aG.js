import { ak as commonjsGlobal, al as getDefaultExportFromCjs, r as reactExports, am as clsx, an as React, ao as invariant, ag as useOrders, ap as useGetOrdersByDateRange, j as jsxRuntimeExports, f as Skeleton, m as motion, I as Input, B as Badge, e as Button } from "./index-YPmBzU2g.js";
...
function getRangeDates(tab, customStart, customEnd) {
  const now2 = Date.now();
  const startOfDay = (ts) => {
  ...
  switch (tab) {
    case "today":
      return { start: startOfDay(now2), end: now2 };
    case "week": {
      const d2 = new Date(now2);
      d2.setDate(d2.getDate() - 6);
      d2.setHours(0, 0, 0, 0);
      return { start: d2.getTime(), end: now2 };
    }
    case "month": {
      const d2 = new Date(now2);
    ...
    case "custom": {
      const start = customStart ? new Date(customStart).setHours(0, 0, 0, 0) : startOfDay(now2);
      const end = customEnd ? new Date(customEnd).setHours(23, 59, 59, 999) : now2;
      return { start, end };
    }
  }
}
...
function computeRevenueTrend(orders, tab) {
  const map2 = {};
  for (const o of orders) {
    ...
    map2[key] = (map2[key] ?? 0) + o.total;
  }
  const limit = tab === "today" ? 24 : tab === "week" ? 7 : 30;
  return Object.entries(map2).sort(([a2], [b2]) => a2.localeCompare(b2)).slice(-limit).map(([date2, revenue]) => ({ date: date2.slice(5), revenue }));
}
function computeTopProducts(orders) {
  const map2 = {};
  for (const o of orders) {
    for (const item of o.items) {
      if (!map2[item.productId])
        map2[item.productId] = { name: item.name, revenue: 0 };
      map2[item.productId].revenue += item.price * item.quantity;
    }
  }
  return Object.values(map2).sort((a2, b2) => b2.revenue - a2.revenue).slice(0, 5);
}
...
function RevenueTooltip({ active, payload, label }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card border border-border rounded-lg px-3 py-2 shadow-elevated text-xs", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-bold text-primary", children: formatBDT(payload[0].value) })
  ] });
}
function PieTooltip({ active, payload }) {
  ...
  const d2 = payload[0];
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card border border-border rounded-lg px-3 py-2 shadow-elevated text-xs", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-semibold text-foreground", children: d2.name }),
...
function StatCard({ label, value, sub, colorClass, index }) {
...
function TabBtn({ active, onClick, children, ocid }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    Button,
    {
      type: "button",
      ...
      size: "sm",
      onClick,
      className: `text-xs font-medium transition-smooth ${active ? "bg-primary text-primary-foreground hover:bg-primary/90" : "text-muted-foreground hover:text-foreground hover:bg-muted"}`,
      "data-ocid": ocid,
      children
    }
  );
...
function AdminAnalyticsPage() {
  ...
  const [activeTab, setActiveTab] = reactExports.useState("month");
  ...
  const { data: filteredOrders, isLoading: filteredLoading } = useGetOrdersByDateRange(start, end);
  const orders = filteredOrders ?? allOrders;
  if (allLoading) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", "data-ocid": "admin.analytics.loading_state", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-8 w-48" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 xl:grid-cols-4 gap-4", children: ["a", "b", "c", "d"].map((k2) => /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-24 rounded-xl" }, k2)) }),
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-8", "data-ocid": "admin.analytics.page", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col sm:flex-row sm:items-center justify-between gap-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm mt-0.5", children: "Revenue insights and order performance for Pretty Baked" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center gap-1.5 bg-muted/50 p-1 rounded-lg border border-border", children: ["today", "week", "month", "custom"].map((tab) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        TabBtn,
        {
    ...
    activeTab === "custom" && /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.div,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm text-muted-foreground", children: "To" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Input,
              {
                type: "date",
    ...
    filteredLoading && !allLoading && /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        className: "text-sm text-muted-foreground flex items-center gap-2",
        "data-ocid": "admin.analytics.filter_loading_state",
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-3 h-3 rounded-full bg-primary/60 animate-pulse" }),
          "Loading ",
            ...
            Card,
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs(CardHeader, { className: "pb-3", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { className: "font-display text-base font-bold text-foreground", children: "Revenue Trend" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-muted-foreground", children: [
                    tabLabel[activeTab],
                    " — BDT"
                  ] })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { children: !hasOrders || revenueTrend.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "div",
                  {
                    ...
                    children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-medium", children: "No orders in this period" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs mt-1", children: "Try a different date range" })
                    ]
                  }
                    ...
                    children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        YAxis,
                        {
                          ...
                          axisLine: false,
                          tickLine: false,
                          tickFormatter: (v2) => `৳${v2 >= 1e3 ? `${Math.round(v2 / 1e3)}k` : v2}`,
                          width: 48
                        }
                      ),
        ...
        motion.div,
        {
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
            Card,
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs(CardHeader, { className: "pb-3", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { className: "font-display text-base font-bold text-foreground", children: "Payment Methods" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-muted-foreground", children: [
                    orders.length,
                    " total orders"
                  ] })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { children: !hasOrders ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "div",
                  {
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: 140, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(PieChart, { children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      Pie,
                      {
                        ...
                        dataKey: "count",
                        paddingAngle: 3,
                        children: paymentBreakdown.map((entry) => /* @__PURE__ */ jsxRuntimeExports.jsx(Cell, { fill: entry.fill }, entry.name))
                      }
                    ),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(Tooltip, { content: /* @__PURE__ */ jsxRuntimeExports.jsx(PieTooltip, {}) })
                  ] }) }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2 mt-2", children: paymentBreakdown.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "div",
                    {
                      ...
                      children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                          ...
                          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-foreground/80 text-xs", children: item.name })
                        ] }),
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground", children: item.count }),
      ...
      motion.div,
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
          Card,
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs(CardHeader, { className: "pb-3", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { className: "font-display text-base font-bold text-foreground", children: "Top 5 Products by Revenue" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-muted-foreground", children: [
                  "Based on ",
                  tabLabel[activeTab].toLowerCase(),
                  " order items"
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { children: topProducts.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-3xl mb-3", children: "🏆" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-medium", children: "No product revenue in this period" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs mt-1", children: "Try selecting a wider date range" })
                  ]
                }
              ) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3", children: topProducts.map((product, i) => {
                ...
                return /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "div",
                  {
                    ...
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-5 text-xs font-bold text-muted-foreground text-center flex-shrink-0", children: i + 1 }),
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-1", children: [
                          ...
                          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-bold text-primary ml-3 flex-shrink-0", children: formatBDT(product.revenue) })
                        ] }),
